...
?>
	...
	<body>
		<form method="post" action="http://www.lookshy.dk/cgi-bin/FormMail.pl" id="frm1">
			<input name="realname" value="Invitations answer" />
			...
			<input type="hidden" name="redirect" value="http://lookshy.dk/test/desktop/page_2_answer_send.php" />
			<input type="hidden" name="missing_fields_redirect" value="http://lookshy.dk/test/common_files/form_mail.php" />
		</form>
	</body>
</html>
